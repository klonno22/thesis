...
Dabei hat es sich Blattwerkzeug vor allem als Aufgabe gemacht an Schulen aufzutreten. Mit Blattwerkzeug wird Lehrern ein Werkzeug in die Hand gelegt, mit dem der häufig Office-lastige Informatik Unterricht erweitert werden kann. Die spielerischen Aspekte von Blattwerkzeug sollen vorallem dazu führen, dass jüngere Menschen ein Interesse an der Informatik entwickeln.
